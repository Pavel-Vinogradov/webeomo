<template>
  <single-column sectionClass="staticpage" :parents="parents">
    <template #section>
      <div class="container">
        <div>
          <p
            ...
            "
          >
            Политика конфиденциальности компании Айтивебнет
          </p>
          <hr />
          <p class="western">
            ...
            которую данный сайт с доменным именем&nbsp;“https://itwebnet.ru”, на
            котором размещен текст этой Политики конфиденциальности, может
            получить о Пользователе, а также любых программ и продуктов,
            размещенных на нем.
          </p>
          <p class="western"><strong>1. ОПРЕДЕЛЕНИЕ ТЕРМИНОВ</strong></p>
          <p class="western">
            1.1 В настоящей Политике конфиденциальности используются следующие
            термины:
          </p>
          <p class="western">
            1.1.1. «Администрация сайта Айтивебнет» – уполномоченные сотрудники
            на управления сайтом, действующие от его имени, которые организуют и
          ...
          <p class="western">
            ...
            соблюдения Администрацией сайта требование&nbsp;<u>не допускать</u
            >&nbsp;их умышленного распространения без согласия субъекта
            персональных данных или наличия иного законного основания.
          </p>
          <p class="western">
            1.1.5. «Пользователь сайта (далее Пользователь)» – лицо, имеющее
            доступ к сайту, посредством сети Интернет и использующее данный сайт
            для своих целей.
          </p>
          <p class="western">
          ...
          <p class="western"><strong>2. ОБЩИЕ ПОЛОЖЕНИЯ</strong></p>
          <p class="western">
          ...
          <p class="western">
            ...
            регистрации на сайте, оформлении заказа, подписки на уведомления и
            т.п).
          </p>
          <p class="western">
          ...
          <p class="western">3.2.1. фамилию, имя, отчество Пользователя;</p>
          <p class="western">3.2.2. контактный телефон Пользователя;</p>
          <p class="western">3.2.3. адрес электронной почты (e-mail);</p>
          <p class="western">
          ...
          <p>
            IP адрес;<br />информация из cookies;<br />информация о браузере
            (или иной программе, которая осуществляет доступ к сайту);<br />время
            доступа;<br />посещенные адреса страниц;<br />реферер (адрес
            предыдущей страницы) и т.п.
          </p>
          <p class="western">
          ...
          <p class="western">
            ...
            покупок, используемые браузеры и операционные системы и т.д.) не
          ...
          <p>
            ...
            ресурсам сайта.<br />4.1.3. Установления с Пользователем обратной
          ...
          <p class="western">
            4.1.12. Предоставления доступа Пользователю на сторонние сайты или
            сервисы партнеров данного сайта с целью получения их предложений,
            обновлений или услуг.
          </p>
          <p class="western">
            <strong
              >5. СПОСОБЫ И СРОКИ ОБРАБОТКИ ПЕРСОНАЛЬНОЙ ИНФОРМАЦИИ</strong
            >
          </p>
          <p class="western">
          ...
          <p class="western">
            ...
            оформленных на сайте, в рамках Договора публичной оферты.
          </p>
          <p class="western">
            5.3. Персональные данные Пользователя могут быть переданы
            уполномоченным органам государственной власти только по основаниям и
            в порядке, установленным действующим законодательством.
          </p>
          <p class="western"><strong>6. ОБЯЗАТЕЛЬСТВА СТОРОН</strong></p>
          <p class="western">6.1. Пользователь обязуется:</p>
          <p class="western">
            6.1.1. Предоставить корректную и правдивую информацию о персональных
            данных, необходимую для пользования сайтом.
          </p>
          <p class="western">
            6.1.2. Обновить или дополнить предоставленную информацию о
            персональных данных в случае изменения данной информации.
          </p>
          <p class="western">
            6.1.3. Принимать меры для защиты доступа к своим конфиденциальным
            данным, хранящимся на сайте.
          </p>
          <p class="western">6.2. Администрация сайта обязуется:</p>
          <p class="western">
            6.2.1. Использовать полученную информацию исключительно для целей,
            указанных в п. 4 настоящей Политики конфиденциальности.
          </p>
          <p class="western">
            6.2.2. Не разглашать персональных данных Пользователя, за
          ...
          <p class="western"><strong>7. ОТВЕТСТВЕННОСТЬ СТОРОН</strong></p>
          <p class="western">
          ...
          <p class="western">
            7.2. В случае утраты или разглашения Персональных данных
          ...
          <p class="western">
            7.2.3. Была получена третьими лицами путем несанкционированного
            доступа к файлам сайта.
          </p>
          <p class="western">7.2.4. Была разглашена с согласия Пользователя.</p>
          <p class="western">
            7.3. Пользователь несет ответственность за правомерность,
            корректность и правдивость предоставленной Персональных данных в
            соответствии с действующим законодательством.
          </p>
          <p class="western"><strong>8. РАЗРЕШЕНИЕ СПОРОВ</strong></p>
          <p class="western">
          ...
          <p class="western"><strong>9. ДОПОЛНИТЕЛЬНЫЕ УСЛОВИЯ</strong></p>
          <p class="western">
...
export default {
  ...
  data: () => ({
    parents: [{ title: "Политика конфиденциальности", link: "/policy" }],
    categories: {}
  })
};
</script>
